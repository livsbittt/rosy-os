...
| 14 Verification | Device validation ARTIFACT/DEVICE/FIELD; ARTIFACT builder is native Pi; ROS-SIM 최소 묶음 | D-71, D-78–D-80, **D-83**, **D-84**, **D-85** | Device GO not claimed; hardware 패키지는 io에 없음 |

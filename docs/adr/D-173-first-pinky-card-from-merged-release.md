...
| 7 | 카드 부팅, first-boot `PROVISIONED`, readback JSON (runbook G0-G2) | 부분 — PROVISIONED·Wi-Fi 정상, 복구 gate import 실패로 CORE 미기동. [D-173](D-173-first-boot-defects-and-boot-indicator.md)로 이관 |

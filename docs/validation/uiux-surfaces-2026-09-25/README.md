...
| Fleet 큐 triage (D-252) | `captures/fleet-queues-triage-1920x1080.png` | 머리 단언(`주의 요망 1·rosy_02`, `개입 요망 1·rosy_01`) 통과, 행·빈 숨김 그대로. 변이(머리 제거) 적색 |
| Fleet 대기 요약 (D-252) | `captures/fleet-formation-pending-1920x1080.png` | 모양 변경 시 안내문 갱신 단언(`LINE` 포함) 통과. 지도 고스트는 서버 기하 단일 출처라 제외 |

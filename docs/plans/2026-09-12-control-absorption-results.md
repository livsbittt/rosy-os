...
현재 코드 기준은 센서 handoff 변경까지 포함한 작업 브랜치다. 최신 Control 회귀는 983 passed·25 skipped,
...
Control 983 passed·25 skipped, 실제 ROS 파라미터/graph 시험 7개와 두 namespace 생성 시험 통과다.

...
| `ROSY ADR Log.md` | ROSY-ADR-001 — append-only decisions through D-186 (D-19 superseded by D-26, D-6 by D-33; D-29 unused gap; D-35 reserved; D-180 reserved by the unmerged perf/sd-single-verify branch) |

...
| D-182 | 안전·명령·내비게이션 코드는 시뮬 파티션과 도메인 리터럴을 모른다 | Proposed |
| D-183 | 그래프 감시는 제품 그래프와 control 단독 그래프를 나눈다 | Proposed |
| D-184 | 동작 시험은 그 패키지가 가지고, core 시험은 공개 계약만 본다 | Proposed |
---

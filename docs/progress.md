...
gates:
  SOURCE:
    state: GO
    evidence: "D-61 Accepted, D-72/D-77/D-153/D-154 본문·색인 일치. SD 개인화 설계/실행 계획 정렬; focused ADR/network 계약 검증 (2026-09-21 Windows); D-169/D-170 추가 (2026-09-22); D-176/D-177 Proposed 추가 (2026-09-23); D-178 Accepted 승격 — 2차 회차 완료+기준선 갱신 (2026-09-23)"

...
TREES = (
    ROOT / "src" / "core" / "core_features" / "core_features" / "safety",
    ROOT / "src" / "core" / "core" / "core" / "bridge",
    ROOT / "src" / "navigation" / "navigation",
)
...
def test_sim_identity_lives_only_in_the_profile_and_safety_does_not_name_it():
    ...
    assert "227" in text
    safety = (ROOT / "src" / "core" / "core_features" / "core_features" / "safety" / "manager.py").read_text(encoding="utf-8")

...
def test_games_overhead_cv2_does_not_close_the_robot_camera_adr():
    ...
    core = ROOT / "src" / "runtime" / "core" / "core"
...
def test_core_has_no_soccer_robot_mode():
    ...
    schemas = (ROOT / "src" / "contracts" / "core_common" / "core_common" / "protocol" / "schemas.py").read_text(
        encoding="utf-8"
    )
...
def test_games_board_is_not_the_core_dashboard():
    ...
    core_web = ROOT / "src" / "runtime" / "core_api_web" / "core_api_web" / "web"
    ...
    app = (ROOT / "src" / "runtime" / "core_api_web" / "core_api_web" / "api" / "app.py").read_text(encoding="utf-8")

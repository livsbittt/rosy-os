...
the immutable release selected by the activation record, the core container,
and the ROS graph observed from that container.  It never serializes the
installer's environment wholesale because that file may contain API tokens.
"""

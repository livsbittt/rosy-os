...
- D-179는 벤치 CORE 수정을 `/var/lib/rosy-dev` 읽기 전용 바인드로 정하고, 그 장치를 릴리스로
  세지 않는다. 실행은 [2026-09-23-core-dev-overlay.md](../docs/plans/2026-09-23-core-dev-overlay.md)다.
  스크립트와 readback은 아직 없다. 제품 `current`와 GitHub 설치 경로는 그대로다.

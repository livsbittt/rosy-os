...
from rosy_control import calibration_storage as storage
from rosy_control.calibration_record import decode_record
...
def test_process_exit_releases_lock_without_removing_lock_file(tmp_path):
    path = tmp_path / 'calibration.yaml'
    script = ('from rosy_control.calibration_lock import calibration_lock\n'
              'import sys\n'

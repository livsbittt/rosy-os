...
class Auxiliary(Node):
    ...
    def on_scan(self, msg):
        ...
        from control.sensing.lidar import sector_range
...
def main():
    ...
    from control.sensing.lidar import enable_simulation_scans
    ...
    for name in ('control.safety.node', 'control.safety.evidence',
                 'control.safety.bumper', 'control.startup_calibration_node',
                 'control.calibration_rotation', 'control.calibration_atomic', 'control.wander.node',
                 'control.wander.senses', 'control.wander.judge', 'control.goal_node'):

...
from control.control.motion_sweep import bounded_sweep_clearance, bounded_translation_limits


def test_final_sweep_preserves_evidence_requirements_and_spin_proof():
    from control.control.motion_sweep import command_sweep_clearance

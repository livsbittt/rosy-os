...
from control.planning import GoalBrain, OccupancyMap, ZigzagPlanner, FREE
from control.planning.zigzag import cover_ring
...
class MappingProgressTest(unittest.TestCase):
    ...
    def test_unreachable_waypoint_is_not_counted_as_visited_or_done(self):
        ...
        pose = (.225, .225)
        with patch('control.planning.goals.best_route', return_value=None):
    ...
    def test_manual_goal_does_not_retry_raw_map_by_default(self):
        ...
        with patch('control.planning.goals.best_route', return_value=None) as route:

...
from control.sensing.obstacle_tracks import ObstacleTracker, transform_points
from control.sensing.obstacle_tracks import scan_clusters
from control.sensing.obstacle_tracks import observed_free
...
def test_tilted_scan_cannot_be_projected_into_a_flat_obstacle_map():
    from control.sensing.obstacle_tracks import scan_plane_pose
    import math

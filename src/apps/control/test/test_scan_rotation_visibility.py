...
from control.sensing.scan_rotation import scan_rotation, percentile80
...
class ScanRotationVisibilityTests(unittest.TestCase):
    ...
    def test_replay_and_random_scan_decisions_match_generic_quantile(self):
        ...
        for first, second, step in cases:
            ...
            with patch('control.sensing.scan_rotation.percentile80', side_effect=lambda x: float(np.quantile(x, .8))):

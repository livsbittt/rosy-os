...
gates:
  ...
  LOCAL:
    state: GO
    evidence: "1114 passed, 26 skipped (2026-09-21 Windows, 패키지 cwd). D-143 IR/camera, D-151 semantic-road detector, D-152 monotonic 2 FPS/depth-1 bounded overlay preview 포함"

...
class LCD():
    ...
    def lcd_init(self):
        ...
        self._write_data_buffer([0xD0, 0x00, 0x02, 0x07, 0x0A, 0x28, 0x32, 0x44, 0x42, 0x06, 0x0E, 0x12, 0x14, 0x17])
        
        # Negative Gamma Correction
        self._write_cmd(0xE1)
        self._write_data_buffer([0xD0, 0x00, 0x02, 0x07, 0x0A, 0x28, 0x31, 0x54, 0x47, 0x0E, 0x1F, 0x1B, 0x1A, 0x1F])

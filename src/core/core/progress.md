...
gates:
  ...
  LOCAL:
    state: GO
    evidence: "1016 passed, 11 skipped (2026-09-21 Windows). D-151 traffic policy와 D-152 sequence-bound, rate-limited authenticated camera preview 포함; Chromium camera/map panel과 재인증 fail-closed 흐름 통과"

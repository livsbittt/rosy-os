...
#include "interfaces/srv/set_lamp.hpp"
...
{
    public:
        RosyLampControl() : Node("lamp_control")
        {
            ...
            srv_set_lamp_ = this->create_service<interfaces::srv::SetLamp>("set_lamp",
    ...
    private:
        void callback_set_lamp(const std::shared_ptr<interfaces::srv::SetLamp::Request> req,
                                        std::shared_ptr<interfaces::srv::SetLamp::Response> res)
        {
    ...
    private:
        ...
        rclcpp::Service<interfaces::srv::SetLamp>::SharedPtr srv_set_lamp_;

...
| `setup.py` / `setup.cfg` | Package install; console script `rosy_omx_adapter` |
...
| Directory | Purpose |
|-----------|---------|
| `rosy_omx_adapter/` | `profile.py` + CLI validator (see `rosy_omx_adapter/AGENTS.md`) |
| `config/` | Intentionally disabled profile YAML (see `config/AGENTS.md`) |
| `test/` | ROS-free profile/CLI tests (see `test/AGENTS.md`) |
| `resource/` | ament index marker `rosy_omx_adapter` |

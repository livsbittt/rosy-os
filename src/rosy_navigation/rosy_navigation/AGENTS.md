...
| `site_map.py` | Use host `site.yaml` only when the image file exists; else demo map |

## For AI Agents

- Import `rosy_navigation.frame_prefix` / `params_rewrite` / `site_map`. Do not add helpers under `launch/`.

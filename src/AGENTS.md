...
| `core/` | `web_common` until the hmi move |
...
python3 -m pytest contracts/core_common/test/ runtime/core/test/ runtime/core_events/test/ runtime/core_features/test/ core/web_common/test/ runtime/control/test/ site/fleet/test products/omx_adapter/test site/games/test -q

...
python3 -m pytest contracts/core_common/test/ runtime/core/test/ runtime/core_events/test/ runtime/core_features/test/ hmi/web_common/test/ runtime/control/test/ site/fleet/test products/omx_adapter/test site/games/test -q

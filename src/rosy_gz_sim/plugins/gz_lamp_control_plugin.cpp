    ...
    gz::sim::EntityComponentManager & /*_ecm*/)
{
    ...
    if (currentTime - last_update_time_ >= 0.1)
    {
        ...
        auto pub = node_.Advertise<gz::msgs::MaterialColor>("/world/rosy_factory/material_color");
...
GZ_ADD_PLUGIN(
    rosy_gz_sim::LampControlPlugin,
    gz::sim::System,
    rosy_gz_sim::LampControlPlugin::ISystemConfigure,
    rosy_gz_sim::LampControlPlugin::ISystemPreUpdate)

...
```bash
python -m pytest src/rosy_fleet/test/test_relay.py src/rosy_fleet/test/test_session.py src/rosy_fleet/test/test_arming.py src/rosy_fleet/test/test_transport.py src/rosy_fleet/test/test_robots.py -v
```
...
- `rosy_fleet.formation` for slots/assignment
- `rosy_core.protocol.schemas` (`RobotMode`, `SwarmFollowParams`)

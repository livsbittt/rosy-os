...
gates:
  SOURCE:
    state: GO
    evidence: "web-common + dashboard 77 passed with ROSY_RUN_BROWSER_TESTS=1 (2026-09-26 Windows)"
  ...
  FIELD:
    state: N/A
adrs: [D-61, D-147, D-168, D-72, D-194, D-195, D-277, D-285, D-286, D-287]
plans:

...
import unittest
import numpy as np
from control.sensing.scan_rotation import scan_rotation
from control.control.rotation_trial import RotationTrial, steady_response
...
class RotationTrialTest(unittest.TestCase):
    def test_quantized_scan_and_startup_delay_validate_steady_response_without_compensation(self):
        ...
        from control.control.calibration_profile import ProfileLease, make_profile
        lease = ProfileLease()

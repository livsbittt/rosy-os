"""Board hardware readback and safe test request API (D-247)."""
...
hardware_router = APIRouter(tags=["host"])
...
@hardware_router.post("/hardware/refresh")
...
@hardware_router.post("/hardware/test")
...
@hardware_router.post("/hardware/confirm")

...
```shell
$ vi /home/robot/rosy_devices/lamp_module_bringup

#!/bin/bash

echo "load kernel module"
/usr/sbin/insmod /home/robot/rosy_devices/rpi_ws281x/rp1_ws281x_pwm/rp1_ws281x_pwm.ko pwm_channel=3
/usr/bin/dtoverlay -d /home/robot/rosy_devices/rpi_ws281x/rp1_ws281x_pwm rp1_ws281x_pwm
...
Type=simple
User=root
ExecStart=/home/robot/rosy_devices/lamp_module_bringup

...
gates:
  ...
  LOCAL:
    state: GO
    evidence: "814 passed, 12 skipped (2026-09-17 Windows). D-72 S0–S6 포함 — evidence, tokens, dashboard G4 게이트, inventory 4상태"
  ...
  FIELD:
    state: PARKED
adrs: [D-1, D-2, D-8, D-18, D-23, D-32, D-38, D-42, D-47, D-58, D-60, D-72, D-75, D-77]
plans:

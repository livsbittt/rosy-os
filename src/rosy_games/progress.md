...
gates:
  ...
  LOCAL:
    state: GO
    evidence: "79 passed plus D-106 Fleet/games cut (2026-09-18 Windows)"
  ...
  FIELD:
    state: PARKED
adrs: [D-90, D-94, D-95, D-96, D-97, D-98, D-99, D-100, D-101, D-102, D-103, D-104, D-105, D-106]
plans:
...
- LOCAL 호스트: 20 Hz 루프 (D-102). arm은 PUT limits (D-104). 스페이스·보드 정지 (D-105). Fleet 매치 버튼은 없음 (D-106).

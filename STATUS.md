...
| [deploy](deploy/progress.md) | 릴리스·플랫폼 | c2bb799 (2026-09-21) | GO | GO | N/A | HOLD | HOLD | N/A |
...
- deploy ARTIFACT: native ARM64 builder는 구현됐지만 아직 aarch64 host에서 실행·offline 서명·검증된 bundle 발행 전
